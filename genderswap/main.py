...
image_path = 'glasses.png' # 'crown.png'
    ...
    try:
        while True:
            ...
            try:
                ...
                lcoord = get_coords(frame, results.face_landmarks.landmark[124])
                rcoord = get_coords(frame, results.face_landmarks.landmark[342]) 
